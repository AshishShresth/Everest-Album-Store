...
namespace EverestAlbumStore.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryName,Description,TotalLoan,ReturningDays")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryName,Description,TotalLoan,ReturningDays")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
